        ...
        <div className="relative aspect-video xs:aspect-[9/16] md:aspect-video overflow-hidden rounded-lg transition-all duration-700 transform hover:scale-[1.02]">
          ...
          {loadError && (
            <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col items-center justify-center z-10">
              ...
              <p className="text-white text-sm text-center px-4">Erro ao carregar o vídeo. Verifique sua conexão.</p>
            </div>
          )}
          ...
          {isInView && (
            <video
              ...
              loop
              playsInline
              className={`w-full h-full xs:object-cover md:object-contain transition-opacity duration-500 ${
